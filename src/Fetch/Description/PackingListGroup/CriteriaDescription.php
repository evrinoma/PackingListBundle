...
namespace Evrinoma\PackingListBundle\Fetch\Description\PackingListGroup;
...
{
    public const NAME = 'api_packing_list_criteria_group';
    protected string $method = Request::METHOD_GET;

    protected function getOptions($entity): array
    {
        /* @var PackingListGroupApiDtoInterface $entity */
