...
use Evrinoma\PackingListBundle\Fetch\Description\PackingListGroup\CriteriaDescription;
use Evrinoma\PackingListBundle\Fetch\Description\PackingListGroup\GetDescription;
 ...
 * @group functional
 */
final class PackingListGroupApiControllerTest extends AbstractFunctionalTest
{
    protected array $serviceDescriptionName = [GetDescription::class, CriteriaDescription::class];

    protected string $actionServiceName = 'evrinoma.packing_list.test.functional.action.packing_list_group';
