 ...
 * @group functional
 */
final class PackingListApiControllerTest extends AbstractFunctionalTest
{
    protected string $actionServiceName = 'evrinoma.packing_list.test.functional.action.packing_list';
