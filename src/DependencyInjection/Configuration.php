...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->scalarNode('handler_packing_list_group')->cannotBeEmpty()->defaultValue(EvrinomaPackingListExtension::HANDLER)->info('This option is used to handler packing list override')->end()
